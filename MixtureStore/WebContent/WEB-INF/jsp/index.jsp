...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<!-- ====================
	Bijay Commented since added the spring tags -->
	<!-- Animate.css -->
...
<spring:url value="/resources/js/js/modernizr-2.6.2.min.js" var="mainJs" />
	<spring:url value="/resources/js/js/respond.min.js" var="respondJs" />
		...
		<div id="fh5co-home" class="js-fullheight" data-section="home">
			...
			<div class="flexslider">
				...
				<div class="fh5co-text">
					<div class="container">
						<div class="row">
							<h1 class="to-animate">Snacks/Namkeen></h1>
							<h2 class="to-animate">Lovely Designed <span>by</span> <a href="http://freehtml5.co/" target="_blank">freehtml5.co</a></h2>
						</div>
					</div>
				</div>
			  	<ul class="slides">
			   	<li style="background-image: url(resources/images/slide_1.jpg);" data-stellar-background-ratio="0.5"></li>
			   	<li style="background-image: url(resources/images/slide_2.jpg);" data-stellar-background-ratio="0.5"></li>
			   	<li style="background-image: url(resources/images/slide_3.jpg);" data-stellar-background-ratio="0.5"></li>
			  	</ul>
			</div>			
		</div>
			...
			<div class="fh5co-main-nav">
				<div class="container-fluid">
					...
					<div class="fh5co-menu-2">
						<a href="#" data-nav-section="menu">All Items</a>
